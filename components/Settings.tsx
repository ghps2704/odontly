  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-slate-500">Personalize o Sozio ERP para sua empresa.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
             <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100 space-y-6">
                <h3 className="text-lg font-semibold flex items-center gap-2 text-slate-700 border-b border-slate-100 pb-2">
                ...
                <div className="space-y-4">
                    <div>
                     ...
                     <div>
                        <label className="block text-sm font-medium text-slate-600 mb-1">Cor Primária (Tema)</label>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100 space-y-6">
                ...
                <p className="text-sm text-slate-500">Defina os percentuais de valor acumulado para classificação de estoque.</p>
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-amber-600 mb-1">Classe B (%)</label>
                        <input 
                            type="number" 
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-600 mb-1">Classe C (%)</label>
                        <input 
                            type="number" 
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-600 mb-1">PIN Admin</label>
                        <input 
                            type="password" 
                            maxLength={4}
                            value={form.adminPin}
                            onChange={e => setForm({...form, adminPin: e.target.value})}
                            className="w-full border border-slate-300 rounded-lg p-2 font-mono tracking-widest bg-white text-slate-900"
                        />
                        <p className="text-xs text-slate-400 mt-1">Acesso Financeiro/Config.</p>
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-slate-600 mb-1">Moeda</label>
                        <select 
                             value={form.currency}
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100 space-y-6 h-fit">
            <h3 className="text-lg font-semibold flex items-center gap-2 text-slate-700 border-b border-slate-100 pb-2">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                ...
                <select 
                    ...
                    className="w-full border border-blue-200 rounded-lg p-2 bg-white text-slate-900 focus:ring-2 focus:ring-blue-500 outline-none"
                >
            ...
            <div className="space-y-4">
                 <div>
                    <label className="block text-sm font-medium text-slate-600 mb-1 flex items-center gap-2">
                        <Target size={16} className="text-purple-600" /> Meta de Faturamento Mensal (Teto)
                    </label>
                    <input 
                        type="number" 
                        ...
                        className="w-full border border-slate-300 rounded-lg p-2 bg-white text-slate-900 font-bold"
                    />
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full pl-9 pr-3 py-2 border border-slate-300 rounded-lg bg-white text-slate-900"
                        />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full pl-9 pr-3 py-2 border border-slate-300 rounded-lg bg-white text-slate-900 font-mono"
                        />
                    </div>
                </div>
